...
L = 4 # Number of sites in x direction
N = 2*L # Number of qubits
...
generators, parameters = UnitaryPruning.hubbard_model_1D(o, L=L, t=t, U=u, k=1)
...
println("Initial expectation value <Z1> (no evolution): ", exp_val_exact)
# Evolve the operator and compute exact evolution
U = UnitaryPruning.build_time_evolution_matrix(generators, parameters)
o_mat = Matrix(o)
m = diag(U'*o_mat*U)
println("Exact expectation value <Z1> after evolution: ", m[1])
